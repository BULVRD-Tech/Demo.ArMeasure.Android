package com.arwrld.armeasure.ar;
...
public class PointCloudRenderer {
    ...
    public void createOnGlThread(Context context) {
        ...
        int vertexShader = ShaderUtil.loadGLShader(TAG, context,
                GLES20.GL_VERTEX_SHADER, com.arwrld.armeasure.R.raw.point_cloud_vertex);
        int passthroughShader = ShaderUtil.loadGLShader(TAG, context,
                GLES20.GL_FRAGMENT_SHADER, com.arwrld.armeasure.R.raw.passthrough_fragment);
